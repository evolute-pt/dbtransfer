...
import pt.evolute.Singleton;
import pt.evolute.arrays.Virtual2DArray;
import pt.evolute.db.DBConstants;
import pt.evolute.db.ExecuterProvider;
import pt.evolute.jdbc.StatementExecuterFactory;
import pt.evolute.sql.backend.Backend;
import pt.evolute.sql.backend.BackendProvider;
import pt.evolute.sql.table.JoinExpression;
import pt.evolute.sql.table.Table;
import pt.evolute.sql.table.TableExpression;
